...
- a hard, unconditional block on any attempt to route a
  press-run-execution decision, or a shop-safety-officer-override
...
press-run-execution decision or a shop-safety-officer judgment
